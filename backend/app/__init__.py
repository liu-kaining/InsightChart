# InsightChart AI Backend Application

import os
import atexit
from flask import Flask
from flask_cors import CORS
from .core import init_config, register_error_handlers, get_config
from .core.logger import init_logging, get_logger
from .middleware import init_request_logging
from .api import auth_bp, file_bp, system_bp, cleanup_bp
    ...
    try:
        ...
        def serve_static(filename):
            ...
            try:
                ...
                try:
                    from flask import send_file
                    logger.debug(f"File {filename} not found, serving index.html for SPA routing")
                    return send_file(os.path.join(app.static_folder, 'index.html'))
                except FileNotFoundError:
